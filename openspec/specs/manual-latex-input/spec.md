# Spec: manual-latex-input

## Purpose

TBD — Defines the Manual LaTeX Input page that provides a textarea with live preview, a submit button that stores LaTeX in CaptureContext and navigates to solve, and back navigation.
