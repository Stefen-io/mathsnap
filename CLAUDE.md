...
This project is indexed by GitNexus as **mathsnap** (1742 symbols, 1832 relationships, 3 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
