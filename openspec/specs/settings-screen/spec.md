...
TBD — Defines the Settings page with a bilingual toggle persisted to localStorage and informational rows including version, onboarding replay, and static contact/terms rows.
